const fr = {
  translations: {
    ...
    'The Team': "L'équipe",
    President: 'Président',
    'VP Communication': 'VP Communication',
    ...
    "The Graasp Association's flagship product is <2>Graasp.eu</2>, a digital education platform accessible on web, mobile, and desktop devices, prepackaged with a suite of integrated learning applications.":
      "La solution phare de l'Association Graasp est <2>Graasp.eu</2>, une plate-forme d'éducation numérique ouverte accessible sur le Web, les appareils mobiles et les ordinateurs de bureau, intégrant une suite d'applications d'apprentissage.",
    'What is Graasp.eu?': 'Qu’est-ce que Graasp?',
    '<0>Graasp.eu</0> is a platform on which you can create your own digital educational activities and resources. To get you started, Graasp provides templates for various learning scenarios, which you can adapt to your needs. You can privately share these resources with your students—or make them available to the rest of the world.':
    ...
    'Do you provide training?': 'Est-ce que vous proposez des formations?',
    'Yes! We understand that institutions and educators have varying levels of experience with digital education. Please contact us at <2>contact@graasp.org</2> to learn more about how we can help you with training.':
      "Oui! Nous sommes conscients que les institutions et les enseignant-e-s ont des niveaux d'expérience variables en matière d'éducation numérique. Si vous souhaitez obtenir davantage d’informations sur nos formations personnalisées, veuillez nous contacter à <2>contact@graasp.org</2>.",
    'Where is Graasp based?': 'Où est basé Graasp?',
    'We are based in Lausanne, Switzerland. Our platforms are compliant with European regulations, including GDPR.':
      'Nous sommes basés à Lausanne, en Suisse. Nos solutions sont également hébergées en Suisse et sont conformes à la réglementation européenne, y compris le RGPD.',
    'The Graasp Association is supported by':
      "L'association Graasp est soutenue par",
    About: 'À propos',
